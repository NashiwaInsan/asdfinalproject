...
public class Menu {
    ...
    static void playAGame(Terminal terminal) {
        ...
        String player1Name = reader
            .readLine("Player 1, enter your name: ")
            .trim();
        if (player1Name.equalsIgnoreCase("/q")) {
            printWelcome(terminal);
            return;
        }
        if (player1Name.isEmpty()) player1Name = "Player 1";

        String player2Name = reader
            .readLine("Player 2, enter your name: ")
            .trim();
        if (player1Name.equalsIgnoreCase("/q")) {
            printWelcome(terminal);
            return;
        ...
        for (int round = 1; round <= 3; round++) {
            ...
            if (player1Diff < player2Diff) {
                ...
                terminal
                    .writer()
                    .println("🎉 " + player1Name + " wins this round!");
            } else if (player2Diff < player1Diff) {
                player2Score++;
                terminal
                    .writer()
                    .println("🎉 " + player2Name + " wins this round!");
            } else {
            ...
            if (player1Score == 2 || player2Score == 2) {
                ...
                terminal
                    .writer()
                    .println("Press ENTER to see final results...");
                terminal.writer().flush();
                reader.readLine();
                break;
            }
        ...
        if (player1Score > player2Score) {
            String winnerBanner = FigletFont.convertOneLine(
                player1Name + " Wins!"
            );
    ...
    static void startDictionarySearch(Terminal terminal) {
        ...
        while (true) {
            ...
            if (query.equalsIgnoreCase("/clear")) {
                // output kamus sangat banyak, kasih kesempatan pengguna untuk
                terminal.puts(Capability.clear_screen);
                continue;
            }
